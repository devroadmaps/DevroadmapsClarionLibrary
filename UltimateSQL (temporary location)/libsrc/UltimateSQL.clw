...
curReturn                                   UltimateDB

    CODE

    RETURN  curReturn.SQLFetch(pKey,pSelect)
...
curReturn                               UltimateDB
    ...
    CODE
        ...
        curReturn.SQLFetchChildren(pKey,pSelect)     
...
Identity                                    LONG
    ...
    CODE
        ...
        SELF.Query('*' & curReturn.SQLInsert(pTbl,pIncludePK))
        IF pGetIdentity
...
curReturn                               UltimateDB
    ...
    CODE
        ...
        RETURN curReturn.SQLUpdate(pTbl)  
...
curReturn                                   UltimateDB
    ...
    CODE
        ...
        RETURN curReturn.SQLDelete(pTbl)        
...
curReturn                               UltimateDB
    ...
    CODE                                      
        ...
        curReturn.SQLLog(pTbl,pLogfile)
