   ...
   MAP
     MODULE('DCL_SYSTEM_POOL_TESTS_BC.CLW')
DctInit     PROCEDURE                                      ! Initializes the dictionary definition module
DctKill     PROCEDURE                                      ! Kills the dictionary definition module
     END
!--- Application Global and Exported Procedure Definitions --------------------------------------------
     MODULE('DCL_SYSTEM_POOL_TESTS001.CLW')
GetPoolItem_VerifyItemsLeft FUNCTION(*long addr),long,pascal   !
GetThree_RemoveOne_GetOne_VerifyReuse FUNCTION(*long addr),long,pascal   !
     END
...
DCL_System_Pool_Tests:Init PROCEDURE(<ErrorClass curGlobalErrors>, <INIClass curINIMgr>)
DCL_System_Pool_Tests:Kill PROCEDURE
   END
...
DLLInitializer.Construct PROCEDURE
  ...
  LocalINIMgr.Init('.\DCL_System_Pool_Tests.INI', NVD_INI) ! Initialize the local INI manager to use windows INI file
  INIMgr &= LocalINIMgr
...
ClarionTest_GetListOfTestProcedures PROCEDURE(*LONG Addr)
    ...
    ClarionTest_ctpl.List.TestName       = 'GetPoolItem_VerifyItemsLeft'
    ClarionTest_ctpl.List.TestGroupName      = '_000_Default'
    ClarionTest_ctpl.List.TestGroupPriority = 0
    ADD(ClarionTest_ctpl.List)
        
    ClarionTest_ctpl.List.TestPriority       = 10
    ClarionTest_ctpl.List.TestName       = 'GetThree_RemoveOne_GetOne_VerifyReuse'
    ClarionTest_ctpl.List.TestGroupName      = '_000_Default'
    ClarionTest_ctpl.List.TestGroupPriority = 0
    ADD(ClarionTest_ctpl.List)
...
DCL_System_Pool_Tests:Init PROCEDURE(<ErrorClass curGlobalErrors>, <INIClass curINIMgr>)
DCL_System_Pool_Tests:Init_Called    BYTE,STATIC

  CODE
  IF DCL_System_Pool_Tests:Init_Called
     RETURN
  ELSE
     DCL_System_Pool_Tests:Init_Called = True
  END
...
DCL_System_Pool_Tests:Kill PROCEDURE
DCL_System_Pool_Tests:Kill_Called    BYTE,STATIC

  CODE
  IF DCL_System_Pool_Tests:Kill_Called
     RETURN
  ELSE
     DCL_System_Pool_Tests:Kill_Called = True
  END
