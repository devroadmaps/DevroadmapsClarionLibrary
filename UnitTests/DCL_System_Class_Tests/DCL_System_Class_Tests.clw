...
Include('DCL_System_ClassParser.inc'),Once
   ...
   MAP
     MODULE('DCL_SYSTEM_CLASS_TESTS_BC.CLW')
DctInit     PROCEDURE                                      ! Initializes the dictionary definition module
DctKill     PROCEDURE                                      ! Kills the dictionary definition module
     END
!--- Application Global and Exported Procedure Definitions --------------------------------------------
     MODULE('DCL_SYSTEM_CLASS_TESTS001.CLW')
ParseClassFile_VerifyClassName FUNCTION(*long addr),long,pascal   !
ParseClassFile_GetExports FUNCTION(*long addr),long,pascal   !
     END
...
DCL_System_Class_Tests:Init PROCEDURE(<ErrorClass curGlobalErrors>, <INIClass curINIMgr>)
DCL_System_Class_Tests:Kill PROCEDURE
   END
...
DLLInitializer.Construct PROCEDURE
  ...
  LocalINIMgr.Init('.\DCL_System_Class_Tests.INI', NVD_INI) ! Initialize the local INI manager to use windows INI file
  INIMgr &= LocalINIMgr
...
DCL_System_Class_Tests:Init PROCEDURE(<ErrorClass curGlobalErrors>, <INIClass curINIMgr>)
DCL_System_Class_Tests:Init_Called    BYTE,STATIC

  CODE
  IF DCL_System_Class_Tests:Init_Called
     RETURN
  ELSE
     DCL_System_Class_Tests:Init_Called = True
  END
...
DCL_System_Class_Tests:Kill PROCEDURE
DCL_System_Class_Tests:Kill_Called    BYTE,STATIC

  CODE
  IF DCL_System_Class_Tests:Kill_Called
     RETURN
  ELSE
     DCL_System_Class_Tests:Kill_Called = True
  END
