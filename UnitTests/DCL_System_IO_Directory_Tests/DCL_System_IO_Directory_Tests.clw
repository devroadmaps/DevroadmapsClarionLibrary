   ...
   MAP
     MODULE('DCL_SYSTEM_IO_DIRECTORY_TESTS_BC.CLW')
DctInit     PROCEDURE                                      ! Initializes the dictionary definition module
DctKill     PROCEDURE                                      ! Kills the dictionary definition module
     END
!--- Application Global and Exported Procedure Definitions --------------------------------------------
     MODULE('DCL_SYSTEM_IO_DIRECTORY_TESTS001.CLW')
Main                   PROCEDURE   !
     END
     MODULE('DCL_SYSTEM_IO_DIRECTORY_TESTS002.CLW')
GetListOfAppsInDirectory_VerifyNames FUNCTION(*long addr),long,pascal   !
...
DCL_System_IO_Directory_Tests:Init PROCEDURE(<ErrorClass curGlobalErrors>, <INIClass curINIMgr>)
DCL_System_IO_Directory_Tests:Kill PROCEDURE
   END
...
DLLInitializer.Construct PROCEDURE
  ...
  LocalINIMgr.Init('.\DCL_System_IO_Directory_Tests.INI', NVD_INI) ! Initialize the local INI manager to use windows INI file
  INIMgr &= LocalINIMgr
...
DCL_System_IO_Directory_Tests:Init PROCEDURE(<ErrorClass curGlobalErrors>, <INIClass curINIMgr>)
DCL_System_IO_Directory_Tests:Init_Called    BYTE,STATIC

  CODE
  IF DCL_System_IO_Directory_Tests:Init_Called
     RETURN
  ELSE
     DCL_System_IO_Directory_Tests:Init_Called = True
  END
...
DCL_System_IO_Directory_Tests:Kill PROCEDURE
DCL_System_IO_Directory_Tests:Kill_Called    BYTE,STATIC

  CODE
  IF DCL_System_IO_Directory_Tests:Kill_Called
     RETURN
  ELSE
     DCL_System_IO_Directory_Tests:Kill_Called = True
  END
